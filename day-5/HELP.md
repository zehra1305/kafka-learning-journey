...
* The original package name 'com.example.day-5' is invalid and this project uses 'com.example.day_5' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.5.14/reference/messaging/kafka.html)
